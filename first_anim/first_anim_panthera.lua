        ...
        animations = {
            ...
            -- =========================================================
            {
                ...
                animation_keys = {
                    ...
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = 6.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.12, duration = 0.08, start_value = 6.0, end_value = -10.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.2, duration = 0.25, start_value = -10.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.0, duration = 0.12, start_value = 129.0, end_value = 127.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.12, duration = 0.08, start_value = 127.0, end_value = 133.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.2, duration = 0.25, start_value = 133.0, end_value = 129.0, easing = "inoutsine" },
                }
            },
            -- =========================================================
            ...
            -- =========================================================
            {
                ...
                duration = 0.5,
                animation_keys = {
                    { key_type = "tween", node_id = "root", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = -2.0, easing = "outquad" },
                    { key_type = "tween", node_id = "root", property_id = "rotation_z", start_time = 0.12, duration = 0.06, start_value = -2.0, end_value = 1.0, easing = "outquad" },
                    { key_type = "tween", node_id = "root", property_id = "rotation_z", start_time = 0.18, duration = 0.32, start_value = 1.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "shadow", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = 2.0, easing = "outquad" },
                    { key_type = "tween", node_id = "shadow", property_id = "rotation_z", start_time = 0.12, duration = 0.06, start_value = 2.0, end_value = -1.0, easing = "outquad" },
                    { key_type = "tween", node_id = "shadow", property_id = "rotation_z", start_time = 0.18, duration = 0.32, start_value = -1.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "body", property_id = "position_x", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = 4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "body", property_id = "position_x", start_time = 0.12, duration = 0.38, start_value = 4.0, end_value = 0.0, easing = "inoutsine" },
                    -- Weapon in hand, recoil kicks barrel up then settles
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = -5.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.12, duration = 0.05, start_value = -5.0, end_value = 14.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.17, duration = 0.08, start_value = 14.0, end_value = 4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.25, duration = 0.25, start_value = 4.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "weapon", property_id = "position_y", start_time = 0.0, duration = 0.12, start_value = 129.0, end_value = 131.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "position_y", start_time = 0.12, duration = 0.38, start_value = 131.0, end_value = 129.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = -2.0, easing = "outquad" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.12, duration = 0.06, start_value = -2.0, end_value = 1.5, easing = "outquad" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.18, duration = 0.32, start_value = 1.5, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "right_leg", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = -2.0, easing = "outquad" },
                    { key_type = "tween", node_id = "right_leg", property_id = "rotation_z", start_time = 0.12, duration = 0.38, start_value = -2.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "left_leg", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = 2.0, easing = "outquad" },
                    { key_type = "tween", node_id = "left_leg", property_id = "rotation_z", start_time = 0.12, duration = 0.38, start_value = 2.0, end_value = 0.0, easing = "inoutsine" },
                    -- hand_right: one-handed, barely follows recoil
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = -3.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.12, duration = 0.05, start_value = -3.0, end_value = 5.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.17, duration = 0.33, start_value = 5.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.0, duration = 0.12, start_value = 129.0, end_value = 130.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.12, duration = 0.38, start_value = 130.0, end_value = 129.0, easing = "inoutsine" },
                }
            },
            -- =========================================================
            ...
            -- =========================================================
            {
                ...
                duration = 0.7,
                animation_keys = {
                    { key_type = "tween", node_id = "root", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = -3.0, easing = "outquad" },
                    { key_type = "tween", node_id = "root", property_id = "rotation_z", start_time = 0.12, duration = 0.58, start_value = -3.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "shadow", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = 3.0, easing = "outquad" },
                    { key_type = "tween", node_id = "shadow", property_id = "rotation_z", start_time = 0.12, duration = 0.58, start_value = 3.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "body", property_id = "position_x", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = 6.0, easing = "outquad" },
                    { key_type = "tween", node_id = "body", property_id = "position_x", start_time = 0.12, duration = 0.58, start_value = 6.0, end_value = 0.0, easing = "inoutsine" },
                    -- Weapon: 3-burst recoil from current position, no repositioning
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = -4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.12, duration = 0.04, start_value = -4.0, end_value = 10.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.16, duration = 0.05, start_value = 10.0, end_value = -4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.21, duration = 0.04, start_value = -4.0, end_value = 10.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.25, duration = 0.05, start_value = 10.0, end_value = -4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.3, duration = 0.04, start_value = -4.0, end_value = 10.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.34, duration = 0.36, start_value = 10.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "weapon", property_id = "position_y", start_time = 0.0, duration = 0.12, start_value = 129.0, end_value = 131.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "position_y", start_time = 0.12, duration = 0.58, start_value = 131.0, end_value = 129.0, easing = "inoutsine" },
                    -- Head: micro-nods per shot
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = -3.0, easing = "outquad" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.12, duration = 0.04, start_value = -3.0, end_value = -1.0, easing = "outquad" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.16, duration = 0.05, start_value = -1.0, end_value = -3.0, easing = "outquad" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.21, duration = 0.04, start_value = -3.0, end_value = -1.0, easing = "outquad" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.25, duration = 0.05, start_value = -1.0, end_value = -3.0, easing = "outquad" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.3, duration = 0.04, start_value = -3.0, end_value = -1.0, easing = "outquad" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.34, duration = 0.36, start_value = -1.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "right_leg", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = -4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "right_leg", property_id = "rotation_z", start_time = 0.12, duration = 0.58, start_value = -4.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "left_leg", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = 4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "left_leg", property_id = "rotation_z", start_time = 0.12, duration = 0.58, start_value = 4.0, end_value = 0.0, easing = "inoutsine" },
                    -- hand_right mirrors weapon (two-handed)
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = -4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.12, duration = 0.04, start_value = -4.0, end_value = 10.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.16, duration = 0.05, start_value = 10.0, end_value = -4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.21, duration = 0.04, start_value = -4.0, end_value = 10.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.25, duration = 0.05, start_value = 10.0, end_value = -4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.3, duration = 0.04, start_value = -4.0, end_value = 10.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.34, duration = 0.36, start_value = 10.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.0, duration = 0.12, start_value = 129.0, end_value = 131.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.12, duration = 0.58, start_value = 131.0, end_value = 129.0, easing = "inoutsine" },
                }
            },
            -- =========================================================
            -- ATTACK_SHOTGUN - weapon in hand, single hard blast + body blown back. Impact at ~0.12s.
            -- =========================================================
            {
                ...
                animation_keys = {
                    { key_type = "tween", node_id = "root", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = -3.0, easing = "outquad" },
                    { key_type = "tween", node_id = "root", property_id = "rotation_z", start_time = 0.12, duration = 0.08, start_value = -3.0, end_value = 5.0, easing = "outquad" },
                    { key_type = "tween", node_id = "root", property_id = "rotation_z", start_time = 0.2, duration = 0.45, start_value = 5.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "shadow", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = 3.0, easing = "outquad" },
                    { key_type = "tween", node_id = "shadow", property_id = "rotation_z", start_time = 0.12, duration = 0.08, start_value = 3.0, end_value = -5.0, easing = "outquad" },
                    { key_type = "tween", node_id = "shadow", property_id = "rotation_z", start_time = 0.2, duration = 0.45, start_value = -5.0, end_value = 0.0, easing = "inoutsine" },
                    -- Body braces forward, hard recoil pushes back
                    { key_type = "tween", node_id = "body", property_id = "position_x", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = 5.0, easing = "outquad" },
                    { key_type = "tween", node_id = "body", property_id = "position_x", start_time = 0.12, duration = 0.08, start_value = 5.0, end_value = -18.0, easing = "outquad" },
                    { key_type = "tween", node_id = "body", property_id = "position_x", start_time = 0.2, duration = 0.45, start_value = -18.0, end_value = 0.0, easing = "inoutsine" },
                    -- Weapon: hard single recoil kick from rest, slow return
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = -4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.12, duration = 0.08, start_value = -4.0, end_value = 22.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.2, duration = 0.45, start_value = 22.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "weapon", property_id = "position_y", start_time = 0.0, duration = 0.12, start_value = 129.0, end_value = 131.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "position_y", start_time = 0.12, duration = 0.08, start_value = 131.0, end_value = 127.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "position_y", start_time = 0.2, duration = 0.45, start_value = 127.0, end_value = 129.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = -3.0, easing = "outquad" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.12, duration = 0.08, start_value = -3.0, end_value = 4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.2, duration = 0.45, start_value = 4.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "right_leg", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = -4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "right_leg", property_id = "rotation_z", start_time = 0.12, duration = 0.08, start_value = -4.0, end_value = 6.0, easing = "outquad" },
                    { key_type = "tween", node_id = "right_leg", property_id = "rotation_z", start_time = 0.2, duration = 0.45, start_value = 6.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "left_leg", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = 4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "left_leg", property_id = "rotation_z", start_time = 0.12, duration = 0.08, start_value = 4.0, end_value = -4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "left_leg", property_id = "rotation_z", start_time = 0.2, duration = 0.45, start_value = -4.0, end_value = 0.0, easing = "inoutsine" },
                    -- hand_right mirrors weapon (two-handed grip)
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = -4.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.12, duration = 0.08, start_value = -4.0, end_value = 22.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.2, duration = 0.45, start_value = 22.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.0, duration = 0.12, start_value = 129.0, end_value = 131.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.12, duration = 0.08, start_value = 131.0, end_value = 127.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.2, duration = 0.45, start_value = 127.0, end_value = 129.0, easing = "inoutsine" },
                }
            },
            -- =========================================================
