        ...
        animations = {
            ...
            -- =========================================================
            {
                ...
                animation_keys = {
                    ...
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.0, duration = 0.2, start_value = 189.0, end_value = 191.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.2, duration = 0.5, start_value = 191.0, end_value = 189.0, easing = "inoutsine" },
                    ...
                    { key_type = "tween", node_id = "hand_right", property_id = "position_x", start_time = 0.32, duration = 0.38, start_value = 100.0, end_value = 105.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.0, duration = 0.1, start_value = 0.0, end_value = -1.5, easing = "outquad" },
            ...
            -- =========================================================
            {
                ...
                animation_keys = {
                    ...
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.0, duration = 0.1, start_value = 189.0, end_value = 187.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.1, duration = 0.55, start_value = 187.0, end_value = 189.0, easing = "inoutsine" },
                    ...
                    { key_type = "tween", node_id = "hand_right", property_id = "position_x", start_time = 0.1, duration = 0.55, start_value = 94.0, end_value = 105.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.0, duration = 0.1, start_value = 0.0, end_value = -1.5, easing = "outquad" },
