    ...
    data = {
        animations = {
            ...
            -- =========================================================
            {
                ...
                duration = 3.0,
                animation_keys = {
                    -- Explicit upright hold on "hit". Idle never otherwise
                    -- touches this node, so without this key a crossfade in
                    -- from "run" (which leans "hit" forward) would leave the
                    -- lean stuck forever - default's lack of a key means the
                    -- last-written value just persists, it doesn't reset.
                    { key_type = "tween", node_id = "hit", property_id = "rotation_z", start_time = 0.0, duration = 3.0, start_value = 0.0, end_value = 0.0, easing = "linear" },
                    ...
                    -- Weapon breathes WITH the torso: bob matches the chest, plus a
                    -- slow sway and a subtle weight shift so it never looks pinned.
                    ...
                    { key_type = "tween", node_id = "weapon", property_id = "position_y", start_time = 0.0, duration = 1.5, start_value = 129.0, end_value = 133.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "weapon", property_id = "position_y", start_time = 1.5, duration = 1.5, start_value = 133.0, end_value = 129.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "weapon", property_id = "position_x", start_time = 0.0, duration = 1.5, start_value = -15.0, end_value = -17.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "weapon", property_id = "position_x", start_time = 1.5, duration = 1.5, start_value = -17.0, end_value = -15.0, easing = "inoutsine" },

                    -- Right hand grips the weapon and rises with it (matched amplitude).
                    ...
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.0, duration = 1.5, start_value = 171.0, end_value = 175.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 1.5, duration = 1.5, start_value = 175.0, end_value = 171.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_x", start_time = 0.0, duration = 1.5, start_value = 85.0, end_value = 83.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_x", start_time = 1.5, duration = 1.5, start_value = 83.0, end_value = 85.0, easing = "inoutsine" },

                    -- Left hand (fore-grip, parented to the weapon) adds a soft wrist sway.
                    { key_type = "tween", node_id = "hand_left", property_id = "rotation_z", start_time = 0.0, duration = 1.5, start_value = 0.0, end_value = -3.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "hand_left", property_id = "rotation_z", start_time = 1.5, duration = 1.5, start_value = -3.0, end_value = 0.0, easing = "inoutsine" },
                }
            },
            -- =========================================================
            ...
            -- =========================================================
            {
                ...
                animation_keys = {
                    ...
                    -- 0.0-0.4 (20->-20) is stance: foot's planted, hip sweeps
                    -- over it, so no lift. 0.4-0.8 (-20->20) is swing: foot's
                    -- off the ground, so it gets a lift arc below (same
                    -- quadruped-style rise/settle the rat's WALK_LIFT uses -
                    -- that bit of vertical travel per step is what reads as
                    -- "walking" instead of gliding/sliding).
                    ...
                    { key_type = "tween", node_id = "right_leg", property_id = "position_y", start_time = 0.4, duration = 0.2, start_value = 145.0, end_value = 153.0, easing = "outsine" },
                    { key_type = "tween", node_id = "right_leg", property_id = "position_y", start_time = 0.6, duration = 0.2, start_value = 153.0, end_value = 145.0, easing = "insine" },

                    -- Left leg: opposite phase - swing (with lift) is 0.0-0.4, stance is 0.4-0.8.
                    ...
                    { key_type = "tween", node_id = "left_leg", property_id = "position_y", start_time = 0.0, duration = 0.2, start_value = 145.0, end_value = 153.0, easing = "outsine" },
                    { key_type = "tween", node_id = "left_leg", property_id = "position_y", start_time = 0.2, duration = 0.2, start_value = 153.0, end_value = 145.0, easing = "insine" },
            ...
            -- =========================================================
            {
                ...
                animation_keys = {
                    ...
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.0, duration = 0.12, start_value = 0.0, end_value = 10.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.12, duration = 0.08, start_value = 10.0, end_value = 8.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "rotation_z", start_time = 0.2, duration = 0.25, start_value = 8.0, end_value = 0.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "weapon", property_id = "position_y", start_time = 0.0, duration = 0.12, start_value = 129.0, end_value = 124.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "position_y", start_time = 0.12, duration = 0.08, start_value = 124.0, end_value = 145.0, easing = "outquad" },
                    { key_type = "tween", node_id = "weapon", property_id = "position_y", start_time = 0.2, duration = 0.25, start_value = 145.0, end_value = 129.0, easing = "inoutsine" },
            ...
            -- =========================================================
            {
                ...
                animation_keys = {
                    ...
                    -- hand_right mirrors weapon recoil (two-handed grip)
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.0, duration = 0.06, start_value = 0.0, end_value = 8.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.06, duration = 0.07, start_value = 8.0, end_value = 1.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.13, duration = 0.06, start_value = 1.0, end_value = 8.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.19, duration = 0.07, start_value = 8.0, end_value = 1.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.26, duration = 0.06, start_value = 1.0, end_value = 8.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.32, duration = 0.38, start_value = 8.0, end_value = 0.0, easing = "outsine" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.0, duration = 0.2, start_value = 171.0, end_value = 173.0, easing = "inoutsine" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.2, duration = 0.5, start_value = 173.0, end_value = 171.0, easing = "outsine" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_x", start_time = 0.0, duration = 0.06, start_value = 85.0, end_value = 80.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_x", start_time = 0.06, duration = 0.07, start_value = 80.0, end_value = 83.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_x", start_time = 0.13, duration = 0.06, start_value = 83.0, end_value = 80.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_x", start_time = 0.19, duration = 0.07, start_value = 80.0, end_value = 83.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_x", start_time = 0.26, duration = 0.06, start_value = 83.0, end_value = 80.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_x", start_time = 0.32, duration = 0.38, start_value = 80.0, end_value = 85.0, easing = "outsine" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.0, duration = 0.1, start_value = 0.0, end_value = -1.5, easing = "outquad" },
            ...
            -- =========================================================
            {
                ...
                animation_keys = {
                    ...
                    -- hand_right mirrors weapon recoil (two-handed grip)
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.0, duration = 0.1, start_value = 0.0, end_value = 18.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "rotation_z", start_time = 0.1, duration = 0.55, start_value = 18.0, end_value = 0.0, easing = "outsine" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.0, duration = 0.1, start_value = 171.0, end_value = 169.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.1, duration = 0.55, start_value = 169.0, end_value = 171.0, easing = "outsine" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_x", start_time = 0.0, duration = 0.1, start_value = 85.0, end_value = 74.0, easing = "outquad" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_x", start_time = 0.1, duration = 0.55, start_value = 74.0, end_value = 85.0, easing = "outsine" },
                    { key_type = "tween", node_id = "head", property_id = "rotation_z", start_time = 0.0, duration = 0.1, start_value = 0.0, end_value = -1.5, easing = "outquad" },
            ...
            -- =========================================================
            {
                ...
                animation_keys = {
                    ...
                    { key_type = "tween", node_id = "hand_right", property_id = "position_x", start_time = 0.0, duration = 0.12, start_value = 85.0, end_value = 85.0, easing = "linear" },
                    { key_type = "tween", node_id = "hand_right", property_id = "position_y", start_time = 0.0, duration = 0.52, start_value = 171.0, end_value = 75.0, easing = "outquad" },
                    ...
                    { key_type = "tween", node_id = "shadow#sprite", property_id = "color_a", start_time = 0.85, duration = 0.55, start_value = 1.0, end_value = 1.0, easing = "outsine" },
                    { key_type = "tween", node_id = "hand_right#sprite", property_id = "color_a", start_time = 0.85, duration = 0.55, start_value = 1.0, end_value = 0.0, easing = "outsine" },
                    { key_type = "tween", node_id = "hand_left#sprite", property_id = "color_a", start_time = 0.85, duration = 0.55, start_value = 1.0, end_value = 0.0, easing = "outsine" },
                    { key_type = "tween", node_id = "weapon_pistol#sprite", property_id = "color_a", start_time = 0.85, duration = 0.55, start_value = 1.0, end_value = 0.0, easing = "outsine" },
                    { key_type = "tween", node_id = "weapon_rifle#sprite", property_id = "color_a", start_time = 0.85, duration = 0.55, start_value = 1.0, end_value = 0.0, easing = "outsine" },
                    { key_type = "tween", node_id = "weapon_shotgun#sprite", property_id = "color_a", start_time = 0.85, duration = 0.55, start_value = 1.0, end_value = 0.0, easing = "outsine" },
                    { key_type = "tween", node_id = "weapon_stabbing#sprite", property_id = "color_a", start_time = 0.85, duration = 0.55, start_value = 1.0, end_value = 0.0, easing = "outsine" },
                    { key_type = "tween", node_id = "weapon_impact#sprite", property_id = "color_a", start_time = 0.85, duration = 0.55, start_value = 1.0, end_value = 0.0, easing = "outsine" },
                }
            }
        },
        metadata = {
            fps = 60,
            gizmo_steps = {},
            gui_path = "first_anim/rigs/human/human.collection",
            layers = {},
            settings = {
                font_size = 30,
            },
